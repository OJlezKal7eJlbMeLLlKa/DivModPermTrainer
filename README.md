# DivModPermTrainer
ENG:
A web trainer for practicing skills of using DIV, MOD and tracing. This game is specially developed for 8-9 grade pupils and their teachers to help to lead classes.
Usage
Open the HTML file 
...
https://developer.mozilla.org/ru/docs/Learn_web_development/Core/CSS_layout/Flexbox
https://quizlet.com/ru
https://ru.duolingo.com/


RU:
Веб-тренажер для отработки навыков использования DIV, MOD и трассировки. Эта игра специально разработана для учеников 8-9 классов и их учителей, чтобы помочь им вести занятия.
Использование
Откройте HTML файл
